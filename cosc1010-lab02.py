...
# Assign the strin "cowboy joe" g "to a variable, and print that variable with title casing
mood = "cowboy joe"
print(mood)
...
hook = "University of wyoming"
cook = "1886"
print(f"The {hook} was founded in {cook}")
